...
def parse_args():
    ...
    iv_parser.add_argument('-gmm', default='model_file/pre-trained-models/iv_plda/final_ubm.txt')
    iv_parser.add_argument('-extractor', default='model_file/pre-trained-models/iv_plda/final_ie.txt')
    iv_parser.add_argument('-plda', default='model_file/pre-trained-models/iv_plda/plda.txt')
    iv_parser.add_argument('-mean', default='model_file/pre-trained-models/iv_plda/mean.vec')
    iv_parser.add_argument('-transform', default='model_file/pre-trained-models/iv_plda/transform.txt')
    iv_parser.add_argument('-model_file', default='model_file/iv_plda/speaker_model_iv_plda')
    
    xv_parser = subparser.add_parser("xv_plda")
    xv_parser.add_argument('-extractor', default='model_file/pre-trained-models/xv_plda/xvecTDNN_origin.ckpt')
    xv_parser.add_argument('-plda', default='model_file/pre-trained-models/xv_plda/plda.txt')
    xv_parser.add_argument('-mean', default='model_file/pre-trained-models/xv_plda/mean.vec')
    xv_parser.add_argument('-transform', default='model_file/pre-trained-models/xv_plda/transform.txt')
